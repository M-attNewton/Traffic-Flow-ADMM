function [Node,Edge,Clique,sol] = cliqueProblemr(CliqueIndex,Clique,Node,Edge,A,opts,iter)
...
%% Get solutions
options = sdpsettings('verbose',opts.subbose,'solver','SDPT3','cachesolvers',1);
...
if sol.problem == 1
    ...
    % Probelm is infeasible, do not change the value
